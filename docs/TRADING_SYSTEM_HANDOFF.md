...
- Not yet chart-verified by the user.
- Next: user regenerates, confirms the MFE/MAE column and the new profit/loss box render correctly alongside the existing lines, then work begins on break-even (stage 2 of the agreed plan above).
