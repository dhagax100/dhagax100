...
def build_manual_rb_gates() -> List[Tuple[datetime, datetime, str, str, str]]:
    ...
    return [
        ...
        (rt(2026, 5, 6, 13, 45), rt(2026, 5, 11, 0, 0), "BOTH", "8", "1"),
        (rt(2026, 5, 11, 0, 0), rt(2026, 5, 14, 18, 0), "BUY_ONLY", "8", "1"),
        ...
        (rt(2026, 7, 23, 15, 43), rt(2026, 7, 27, 0, 0), "BOTH", "8", "14"),
        (rt(2026, 7, 27, 0, 0), rt(2026, 7, 29, 21, 53), "SELL_ONLY", "8", "14"),
